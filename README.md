...
**AegisGraph** is a web-based investigation tool that converts simple transaction CSV files into a visual network graph. This helps detect hidden fraud patterns that are hard to see in normal tables. It can identify:
